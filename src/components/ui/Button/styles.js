...
import {ReactComponent as Cross } from './../../../assets/iсons/button-elements/cross.svg';
import {ReactComponent as ExclamationPoint } from './../../../assets/iсons/button-elements/exclamation-point.svg';
...
export const IconCross = styled(Cross)`
  ...
  height:24px;
`;
export const IconExclamationPoint = styled(ExclamationPoint)`
  width:24px;
  height:24px;
`;
